...
{
    private const string MultiSyllabusRuntimeRepairSql = """
    ...
    public static void ApplyMigrations(this IApplicationBuilder app)
    {
        ...
        try
        {
            ...
            ApplyMultiSyllabusRuntimeSchemaRepairs(dbContext, logger);
    ...
    private static void ApplyMultiSyllabusRuntimeSchemaRepairs(
        ...
        ILogger<ApplicationDbContext> logger)
    {
        ...
        logger.LogInformation("Applying idempotent multi-syllabus runtime schema repairs");
        dbContext.Database.ExecuteSqlRaw(MultiSyllabusRuntimeRepairSql);
        logger.LogInformation("Multi-syllabus runtime schema repairs applied successfully");
    }
}
