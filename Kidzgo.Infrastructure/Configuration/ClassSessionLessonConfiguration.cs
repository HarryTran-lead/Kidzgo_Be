...
public class ClassSessionLessonConfiguration : IEntityTypeConfiguration<ClassSessionLesson>
{
    public void Configure(EntityTypeBuilder<ClassSessionLesson> builder)
    {
        ...
        builder.HasOne(x => x.SessionTemplate)
            .WithMany(x => x.ClassSessionLessons)
